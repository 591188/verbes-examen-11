...
function conj_avoir(sujet) {
    switch (sujet) {
        case SUJET_JE: return "aurai";
        case SUJET_TU: return "auras";
        case SUJET_IL:
        case SUJET_ELLE:
        case SUJET_ON:
            return "aura";
        case SUJET_NOUS: return "aurons";
        case SUJET_VOUS: return "aurez";
        case SUJET_ILS:
        case SUJET_ELLES:
            return "auront";
    }
...
function conj_etre(sujet) {
    switch (sujet) {
        case SUJET_JE: return "serai";
        case SUJET_TU: return "seras";
        case SUJET_IL:
        case SUJET_ELLE:
        case SUJET_ON:
            return "sera";
        case SUJET_NOUS: return "serons";
        case SUJET_VOUS: return "serez";
        case SUJET_ILS:
        case SUJET_ELLES:
            return "seront";
    }
